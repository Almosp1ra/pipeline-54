...
set_property PACKAGE_PIN J15 [get_ports {display_switch[0]}]
set_property PACKAGE_PIN L16 [get_ports {display_switch[1]}]


set_property IOSTANDARD LVCMOS33 [get_ports {display_switch[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {display_switch[0]}]
